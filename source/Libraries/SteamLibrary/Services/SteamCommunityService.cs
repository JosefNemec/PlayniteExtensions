...
{
    /// <summary>
    /// Former login provider, no longer used
    /// </summary>
    public class SteamCommunityService : SteamAuthServiceBase
    {
        protected override string TargetUrl => "https://steamcommunity.com/my/edit/info";
